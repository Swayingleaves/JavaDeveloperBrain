...
- [线程池](Java-多线程/线程池.md)
  ...
  * [ThreadPoolExecutor](Java-多线程/线程池.md#threadpoolexecutor-1)
      * [参数含义](Java-多线程/线程池.md#参数含义)
        * [1、corePoolSize](Java-多线程/线程池.md#1corepoolsize)
        * [2、maximumPoolSize](Java-多线程/线程池.md#2maximumpoolsize)
        * [3、keepAliveTime](Java-多线程/线程池.md#3keepalivetime)
        * [4、unit](Java-多线程/线程池.md#4unit)
        * [5、workQueue](Java-多线程/线程池.md#5workqueue)
        * [6、threadFactory](Java-多线程/线程池.md#6threadfactory)
        * [7、handler](Java-多线程/线程池.md#7handler)
...
- [ThreadLocal](Java-多线程/ThreadLocal.md)
  ...
  * [FastThreadLocal](Java-多线程/ThreadLocal.md#fastthreadlocal)
    * [源码分析](Java-多线程/ThreadLocal.md#源码分析-1)
  * [参考文章：](Java-多线程/ThreadLocal.md#参考文章)
...
- [跨域](计算机网络/跨域.md)
  ...
  * [<a href="#">解决方案</a>](计算机网络/跨域.md#解决方案)f
...
* [HBASE](数据库/Hbase.md#hbase)
  ...
  * [列式存储](数据库/Hbase.md#列式存储)
    ...
    * [列：属于某一个列簇，在 HBase 中可以进行动态的添加](数据库/Hbase.md#列属于某一个列簇在-hbase-中可以进行动态的添加)
    * [Cell : 是指具体的 Value](数据库/Hbase.md#cell--是指具体的-value)
    * [TimeStamp ：在这张图里面没有显示出来，这个是指版本号，用时间戳（TimeStamp ）来表示。](数据库/Hbase.md#timestamp-在这张图里面没有显示出来这个是指版本号用时间戳timestamp-来表示)
  * [架构](数据库/Hbase.md#架构)
...
* [HBase 架构组件](数据库/Hbase.md#hbase-架构组件)
  ...
  * [这些组件是如何一起工作的](数据库/Hbase.md#这些组件是如何一起工作的)
  * [第一次读和写操作](数据库/Hbase.md#第一次读和写操作)
  ...
  * [HBase HFile](数据库/Hbase.md#hbase-hfile)
    * [HBase HFile 文件结构](数据库/Hbase.md#hbase-hfile-文件结构)
    * [HFile 索引](数据库/Hbase.md#hfile-索引)
...
* [选举算法](数据库/Elasticsearch.md#选举算法)
  * [7.X之前的选主流程](数据库/Elasticsearch.md#7x之前的选主流程)
    * [什么时候开始选主？](数据库/Elasticsearch.md#什么时候开始选主)
    * [Bully算法缺陷](数据库/Elasticsearch.md#bully算法缺陷)
      * [Master假死](数据库/Elasticsearch.md#master假死)
      * [脑裂](数据库/Elasticsearch.md#脑裂)
        * [如何解决脑裂问题](数据库/Elasticsearch.md#如何解决脑裂问题)
      * [仍然存在的问题](数据库/Elasticsearch.md#仍然存在的问题)
  * [7.X之后的选主流程](数据库/Elasticsearch.md#7x之后的选主流程)
    * [ES实现的Raft算法选主流程](数据库/Elasticsearch.md#es实现的raft算法选主流程)
      * [动态维护参选节点列表](数据库/Elasticsearch.md#动态维护参选节点列表)
...
* [点 VID](数据库/Nebula.md#点-vid)
  * [VID 的特点](数据库/Nebula.md#vid-的特点)
  * [VID 使用建议](数据库/Nebula.md#vid-使用建议)
  * [VID 生成建议](数据库/Nebula.md#vid-生成建议)
  * [定义和修改 VID 与其数据类型](数据库/Nebula.md#定义和修改-vid-与其数据类型)
  * ["查询起始点"(start vid) 与全局扫描](数据库/Nebula.md#查询起始点start-vid-与全局扫描)
* [服务架构](数据库/Nebula.md#服务架构)
  * [架构总览](数据库/Nebula.md#架构总览)
    * [Meta 服务](数据库/Nebula.md#meta-服务)
    * [Graph 服务和 Storage 服务](数据库/Nebula.md#graph-服务和-storage-服务)
  * [Meta 服务](数据库/Nebula.md#meta-服务-1)
    * [Meta 服务架构](数据库/Nebula.md#meta-服务架构)
    * [Meta 服务功能](数据库/Nebula.md#meta-服务功能)
  * [Graph服务](数据库/Nebula.md#graph服务)
    * [Graph 服务架构](数据库/Nebula.md#graph-服务架构)
    * [Parser](数据库/Nebula.md#parser)
    * [Validator](数据库/Nebula.md#validator)
    * [Planner](数据库/Nebula.md#planner)
    * [Executor](数据库/Nebula.md#executor)
  * [Storage服务](数据库/Nebula.md#storage服务)
    * [优势](数据库/Nebula.md#优势)
    * [Storage 服务架构](数据库/Nebula.md#storage-服务架构)
    * [KVStore](数据库/Nebula.md#kvstore)
    * [数据存储格式](数据库/Nebula.md#数据存储格式)
    * [属性说明](数据库/Nebula.md#属性说明)
    * [数据分片](数据库/Nebula.md#数据分片)
    * [Raft](数据库/Nebula.md#raft)
    * [与 HDFS 的区别](数据库/Nebula.md#与-hdfs-的区别)
## <a>消息队列</a>[↑↑](#内容概览)
### Redis[↑↑](#内容概览)
- [Redis](消息队列/Redis.md)
...
- [RabbitMQ](消息队列/RabbitMQ.md)
    ...
    * [事务机制](消息队列/RabbitMQ.md#事务机制)
        * [步骤](消息队列/RabbitMQ.md#步骤)
        * [事务回滚](消息队列/RabbitMQ.md#事务回滚)
...
* [消息存储原理与 ID 规则](消息队列/Pulsar.md#消息存储原理与-id-规则)
  ...
  * [分片机制详解：Legder 和 Entry](消息队列/Pulsar.md#分片机制详解legder-和-entry)
    * [Journals](消息队列/Pulsar.md#journals)
    * [EntryLogFile](消息队列/Pulsar.md#entrylogfile)
    * [Index 文件](消息队列/Pulsar.md#index-文件)
    * [Entry 数据写入](消息队列/Pulsar.md#entry-数据写入)
    * [Entry 数据读取](消息队列/Pulsar.md#entry-数据读取)
    * [数据一致性保证：LastLogMark](消息队列/Pulsar.md#数据一致性保证lastlogmark)
* [消息副本与存储机制](消息队列/Pulsar.md#消息副本与存储机制)
  * [消息元数据组成](消息队列/Pulsar.md#消息元数据组成)
  * [消息副本机制](消息队列/Pulsar.md#消息副本机制)
    * [消息副本分布](消息队列/Pulsar.md#消息副本分布)
...
- [分布式唯一ID设计](分布式相关/分布式ID.md#分布式唯一id设计)
  ...
  * [美团Leaf算法](分布式相关/分布式ID.md##美团leaf算法)
    * [Leaf-segment数据库方案 号段模式](分布式相关/分布式ID.md##leaf-segment数据库方案-号段模式)
    * [Leaf-snowflake方案](分布式相关/分布式ID.md##leaf-snowflake方案)
- [CAP理论](分布式相关/CAP.md)
