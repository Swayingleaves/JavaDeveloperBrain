...
* [Linux](#linux)
  ...
  * [cpu100%怎么排查](#cpu100怎么排查)
    ...
    * [3、排查](#3排查)
  * [用户态和内核态](#用户态和内核态)
    * [用户态和内核态的转换](#用户态和内核态的转换)
      * [系统调用](#系统调用)
      * [异常](#异常)
      * [外围设备的中断](#外围设备的中断)
    * [切换操作](#切换操作)
* [LINUX 的进程、线程、文件描述符是什么](#linux-的进程线程文件描述符是什么)
  * [一、进程是什么](#一进程是什么)
  * [二、文件描述符是什么](#二文件描述符是什么)
  * [三、线程是什么](#三线程是什么)
  * [创建进程的方式](#创建进程的方式)
    * [fork](#fork)
    * [vfork](#vfork)
...
* [select、poll、epoll](#selectpollepoll)
  ...
  * [epoll](#epoll)
    * [epoll操作过程](#epoll操作过程)
      ...
      * [int epoll_ctl(int epfd, int op, int fd, struct epoll_event *event)；](#int-epoll_ctlint-epfd-int-op-int-fd-struct-epoll_eventevent)
...
![](../img/Linux/父进程和子进程.png)

![](../img/Linux/父进程和子线程.png)
